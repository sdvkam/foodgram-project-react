# Generated by Django 2.2.19 on 2022-02-01 22:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, help_text='Уникальное.<br>Можно оставить пустым, тогда будем сформирован автоматически из названия рецепта и его номера в базе.<br>Будьте осторожны при самостоятельном редактировании.', max_length=200, unique=True, verbose_name='Английское имя для рецепта')),
